    ...
    <div class="ml-auto position-relative">
      <div class="links-section">
        <?php if( is_user_logged_in() ) : ?>
          <a class="position-absolute dropdown-toggle" style="left: 0;" href="<?php echo get_the_permalink( '159' ) ?>" id="account" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-circle" style="font-size: 2.8em;"></i><?php //_e( 'Dashboard' ) ?></a>
        ...
        <?php else: ?>
          <a class="position-absolute" style="left: 10px;" href="<?php echo get_the_permalink( '151' ) ?>"><i class="fas fa-user-circle" style="font-size: 2.8em;"></i><?php //_e( 'Sign In' ) ?></a>
        <?php endif; ?>
